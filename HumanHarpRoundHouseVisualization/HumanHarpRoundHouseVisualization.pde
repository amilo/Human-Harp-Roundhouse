...
void recordMovie(String a){   //start recording a movie
 
   String num = a;
String name = num + ".flv";
  // Save as THEORA in a OGG file as MEDIUM quality (all quality settings are WORST, LOW,
  // MEDIUM, HIGH and BEST):
 // mm = new GSMovieMaker(this, width, height, name, GSMovieMaker.THEORA, GSMovieMaker.BEST, fps);
  mm = new GSMovieMaker(this, width, height, name, GSMovieMaker.X264, GSMovieMaker.BEST, fps);
